    ...
    >
      ...
      >
        <svg
          ...
          stroke-width="2"
          class="w-10 h-10 text-white p-2 bg-gray-700 rounded-full"
          viewBox="0 0 24 24"
        >
          <path
        ...
        <span class="ml-3 text-xl">Differential Design</span>
      </a>
      <p
        class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4"
      >
        © {{ year }} differential design —
      ...
      >
        ...
        <!-- <a class="twitter ml-3 text-gray-500">
          <svg
            fill="currentColor"
            stroke-linecap="round"
            stroke-linejoin="round"
        ...
        <a
          class="instagram ml-3 text-gray-500"
        ...
        <a
          class="linkedin ml-3 text-gray-500"
